...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
    ...
    void respond(ProxyToServerConnection serverConnection, HttpFilters filters,
        ...
        httpObject = filters.proxyToClientResponse(new ComplexProxyToClientResponse(serverConnection.getServerHostAndPort(), httpObject));
        if (httpObject == null) {
            forceDisconnect(serverConnection);
            return;
        }
     ...
     * {@link HttpFilters#proxyToClientResponse(ComplexProxyToClientResponse)} filter method before writing it to the client. The client
    ...
    private boolean respondWithShortCircuitResponse(HttpResponse httpResponse) {
        ...
        HttpResponse filteredResponse = (HttpResponse) currentFilters.proxyToClientResponse(new ComplexProxyToClientResponse(null, httpResponse));
